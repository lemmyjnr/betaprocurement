-- Run this in Supabase's SQL Editor, after 015 and 016.
-- Three changes to the status-change emails:
--   1. "Dear Customer" -> "Dear <actual customer name>" (falls back
--      to "Dear Customer" if a customer somehow has no name on file)
--   2. The "received" email now states how many tracking numbers
--      were received under the batch
--   3. Every email now has the Beta Courier & Logistics logo at the
--      top and a footer with website/phone/address at the bottom
